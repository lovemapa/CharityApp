...
}, _defineProperty(_constant, 'EXISTSMSG', 'associated with another account(Account already taken, try another)'), _defineProperty(_constant, 'PARAMSMISSING', 'Parameters Missing'), _defineProperty(_constant, 'PARAMSGROUPMISSING', 'Provide group ID'), _defineProperty(_constant, 'OBJECTIDERROR', 'Provide valid user ObjectIDs'), _defineProperty(_constant, 'PARAMSMISSINGCHATHISTORY', 'Provide both sender and reciever Id'), _defineProperty(_constant, 'PARAMSMISSINGGROUPCHATHISTORY', 'Provide sender Id'), _defineProperty(_constant, 'BLOCKMESSAGE', 'You cannot send mesage.You are blocked by the user'), _defineProperty(_constant, 'ALREADYBLOCKED', 'User is already blocked'), _defineProperty(_constant, 'UNBLOCKED', 'User is unblocked succesfully'), _defineProperty(_constant, 'BLOCKED', 'User is blocked Successfully'), _defineProperty(_constant, 'USERIMAGE', 'static/users/'), _defineProperty(_constant, 'MESSAGEMEDIA', 'static/media/'), _defineProperty(_constant, 'BASEURL', 'http://13.232.208.65:9000/'), _constant);
